...
public class WeekReference {
    public static void main(String[] args) {
        //new WeekReference().demoWeakHashMap();
        //new WeekReference().demoWeakHashMap2();
        new WeekReference().demoWeakHashMap3();
    }
    ...
    public void demoWeakHashMap2() {
        ...
        System.out.println(Runtime.getRuntime().freeMemory());
        Long[] arr1 = new Long[1024 * 1024 * 10]; //80Mb
